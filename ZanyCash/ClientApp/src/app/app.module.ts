...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forRoot([
      ...
      { path: Routes.SetRecurringTransactions, component: SetRecurringTransactionComponent, canActivate: [AuthorizeGuard] },
      { path: Routes.Liquidity, component: LiquidityDashboardComponent, canActivate: [AuthorizeGuard] },
    ]),
